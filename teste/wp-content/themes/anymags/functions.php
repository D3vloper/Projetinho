...
function anymags_scripts() {
	...
	wp_enqueue_style('anymags_meanmenu_css',get_template_directory_uri().'/assets/css/meanmenu.css');
	...
	wp_enqueue_script( 'anymags_meanmenu.js', get_template_directory_uri() . '/assets/js/meanmenu.js', array('jquery'), _S_VERSION, true );
